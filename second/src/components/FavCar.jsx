...
function FavCar() {
    ...
    //         <input type="text" value={car.model} className="carInp" onChange={(event) => {changeCar(event,1)}} />
    //         <input type="text" value={car.color} className="carInp" onChange={(event) => {changeCar(event,2)}} />
    //         <input type="text" value={car.year} className="carInp" onChange={(event) => {changeCar(event,3)}} />
    //     </div>
    // )
    let [car, setCar] = useState({
        year: 2024,
